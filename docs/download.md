...
- [Download installer: `make_markdown_library-0.3.8-py3-none-any.whl`](https://github.com/markbeachill/make-markdown-library/releases/download/v0.3.8/make_markdown_library-0.3.8-py3-none-any.whl)
...
- [Open release v0.3.8](https://github.com/markbeachill/make-markdown-library/releases/tag/v0.3.8)
...
| File | Use it for |
| --- | --- |
| `make_markdown_library-0.3.8-py3-none-any.whl` | Installing the tool |
